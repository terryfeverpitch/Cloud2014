package com.cloud2014.assignment.client;

import java.util.Date;

import com.cloud2014.assignment.client.page.HomePage;
import com.cloud2014.assignment.client.page.LoginPage;
import com.cloud2014.assignment.client.page.SignupPage;
import com.cloud2014.assignment.client.service.AccountService;
import com.cloud2014.assignment.client.service.AccountServiceAsync;
 ...
 */
public class Cloud2014_assignment implements EntryPoint {
				...
				accountService.verify(loginPage.tb_username.getText(), loginPage.ptb_password.getText(), 
					...
					public void onSuccess(Integer result) {
						if(result == MessageCode.VERIFY_FAILURE_UNAVAILABLE) {
							...
							dialog.hide();
							dialog = null;
							homepage = new HomePage(result);
							homepage.build(loginPage.tb_username.getText());
							RootPanel.get("mainView").add(homepage);
						}
